    ...
    <div class="scrollbar-inner">
      ...
      <div class="sidenav-header  align-items-center">
        <a class="navbar-brand" href="javascript:void(0)">
          ...
          <span class="nav-link-text"> Arsip-Ku</span>
        </a>
      </div>
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?= base_url('Puskesmas/') ?>">
                ...
                <span class="nav-link-text">Puskesmas</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?= base_url('Sirs/') ?>">
                <i class="ni ni-sound-wave text-primary"></i>
                <span class="nav-link-text">si-Rs</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?= base_url('/Wahana') ?>">
                <i class="ni ni-collection text-primary"></i>
                <span class="nav-link-text">Wahana</span>
              </a>
            </li>
          </ul>
          <!-- Divider -->
                    ...
                    <div class="row align-items-center">
                      ...
                      <div class="col ml--2">
                        <div class="d-flex justify-content-between align-items-center">
                          <div>
                            <h4 class="mb-0 text-sm"><?= $this->session->userdata('username') ?></h4>
                          </div>
