...
<div class="card">
  ...
  <div class="card-header">
    ...
    <div class="col-md-6" style="display: block;">
      <a href="<?= base_url('Wahana/v_tambah') ?>" class="fa fa-plus btn btn-info btn-sm float-right"></a>
    </div> 
  </div>
  </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    table = $('#puskesmas').DataTable({
      ...
      "ajax": {
        "url": "<?php echo site_url('Wahana/datatable_wahana')?>",
        "type": "POST"
      },
